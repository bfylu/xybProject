...
public class MemberBillDetail implements Serializable {
    private Long id;
    ...
    private Long installmentTotalAmount;
    ...
    public Long getInstallmentTotalAmount() {
        return installmentTotalAmount;
    }

    public void setInstallmentTotalAmount(Long installmentTotalAmount) {
