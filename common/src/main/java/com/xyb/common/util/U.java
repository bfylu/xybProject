...
public final class U {
    ...
    public static <T> void assertEmpty(Collection<T> list, String msg) throws Exception {
        assertException(A.isEmpty(list), msg);
    }

    /** 数组为 null 或 长度为 0 时则抛出异常 */
    public static <T> void assertEmpty(T[] array, String msg) throws Exception {
        assertException(A.isEmpty(array), msg);
    }

    /** map 为 null 或 长度为 0 时则抛出异常 */
    public static <K,V> void assertEmpty(Map<K,V> map, String msg) throws Exception {
        assertException(A.isEmpty(map), msg);
    }
    ...
    /** 字符长度不在指定的倍数之间则抛出异常 */
    public static void assertLength(String str, int min, int max, String name) throws Exception {
    ...
    /** 抛出业务异常 */
    public static void assertException(String msg) throws Exception {
        throw new Exception(msg);
    }

    /** 条件为 true 则抛出必须处理的异常 */
    public static void assertMustHandleException(Boolean flag, String msg) throws Exception {
        if (flag != null && flag) {
            throw new Exception(msg);
        }
    }
